...
/**
 * Physical plan for keeping one row per distinct value of {@link #key}.
 * When {@link #failOnDuplicate} is true, duplicate keys raise an error instead of silently dropping rows.
 * Used by equi-join uniqueness (one-to-one) after {@link HashJoinExec}.
 */
